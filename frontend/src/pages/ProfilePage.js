...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        const response = await axios.get('https://prjfinal-studi.onrender.com/api/profile', {
          headers: {
  ...
  const handleLogout = async () => {
    try {
      await axios.post('https://prjfinal-studi-frontend.com/api/logout', {}, { withCredentials: true });
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await axios.put('https://prjfinal-studi.onrender.com/api/profile', {
        email: newEmail, 
